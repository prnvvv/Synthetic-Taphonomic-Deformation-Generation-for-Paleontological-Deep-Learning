...
Image Resolution & 224 × 224 px & INTER\_AREA resize from raw MIP \\
Image Format & PNG (uint8 grayscale) & Grayscale, no color channels \\
Random Seed & 42 & Reproducible with np.random.default\_rng(42) \\
Label Format & CSV (11 columns) & image\_id, specimen, deformation\_type, params, … \\
\bottomrule
\end{tabular}
\end{table}
